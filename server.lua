...
RegisterServerEvent('cooking:combination1') -- Food combination function 1
...
RegisterServerEvent('cooking:combination2') -- Food combination function 2
...
RegisterServerEvent('brewing:combination1') -- Drink combination function 1
AddEventHandler('brewing:combination1', function()
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('brewing:combination2') -- Drink combination function 2
AddEventHandler('brewing:combination2', function()
    local xPlayer = ESX.GetPlayerFromId(source)
	local xItem1 = xPlayer.getInventoryItem('coffee_bean') -- Item 1 
	local xItem2 = xPlayer.getInventoryItem('sugar') -- Item 2 
	local xItem3 = xPlayer.getInventoryItem('water') -- Item 3
